    ...
    <>
      <div id="Contact" className="mx-5 md:mx-8 lg:mx-10 mt-10">
        <div className="lg:flex lg:gap-10 font-normal">
          <div className="mt-5 bg-[#FFB96D] lg:w-[700px] px-5 md:px-8 lg:px-10 py-5 md:py-8 lg:py-10 rounded-3xl">
          ...
          <form className="mt-5 bg-[#FFEDD3] w-full lg:w-[700px] px-5 md:px-8 lg:px-10 rounded-3xl py-8 md:py-10 lg:py-14">
            <div>
              <label
                htmlFor="fullName"
              ...
              <input
                ...
                className=" outline-none text-sm mt-1 p-3 w-full rounded-2xl border-2  bg-white text-black font-semibold"
              />
            </div>
            <div className="mt-8">
              <label
            ...
            <div className="mt-8">
              ...
              <input
                ...
                className=" outline-none text-sm mt-1 px-2 py-5  w-full rounded-2xl border-2  bg-white text-black font-semibold"
              />
            </div>
