    ...
    <div id="#">
      <div className="mt-5 relative lg:mx-10 md:mx-8 mx-5 overflow-hidden md:block hidden">
        <img
          ...
          className="w-full h-[300px] md:h-[400px] lg:h-[600px] rounded-3xl object-cover"
        />
        <div className="absolute sm:top-[30px] lg:top-[50px] md:top-[40px] top-[30px] sm:left-[20px] left-20 md:left-[30px] w-full">
          ...
          <h1 className="md:text-xl lg:text-4xl sm:text-xl text-lg w-1/2 font-semibold md:mt-3 lg:mt-10 text-white">
            Effortless{" "}
            <span className="text-white mx-2">
              Hostel Management <span className="text-orange-500">&</span>{" "}
            </span>
          </h1>

          <h1 className="md:text-xl lg:text-4xl font-semibold text-white">
            Seamless <span className="text-white">Operations</span>
          </h1>

          <h1 className="text-xl md:text-xl lg:text-xl font-semibold md:mt-3 lg:mt-20 text-white">
            Manage Your Hostels
            <h1>Anytime, Anywhere</h1>
          </h1>

          <div class="h-[56px]  lg:w-[300px] md:w-[270px]  mt-[50px] rounded-md bg-gradient-to-r from-[#125AA0] via-[#e91296] to-[#ef3535]  p-0.5">
            <div class="flex h-[52px]   w-full items-center justify-center  rounded-md bg-[#0d1f2f]">
      ...
      <div className="mt-2 mx-5 block md:hidden relative">
        ...
        <div className="absolute top-0 left-0 right-0 bottom-0 bg-black rounded-3xl bg-opacity-50 flex flex-col items-center justify-center px-5">
          ...
          <a
            href="#Contact"
            className="bg-orange-500 px-4 py-2 sm:px-10 sm:py-3 rounded-full text-white font-semibold text-sm mt-3 sm:mt-5"
          >
            Start with a Free Trial Today!
          </a>
        </div>
